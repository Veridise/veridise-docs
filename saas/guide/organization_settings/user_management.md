...
2. **If the user is not yet onboarded in AuditHub**, they will receive an email with instructions to complete their registration. After confirming their email address, they will be automatically added to the organization without needing to request access, as described in the [Onboarding](/saas/guide/on_boarding.md#access-request) section.
