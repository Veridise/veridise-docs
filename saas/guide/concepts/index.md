...
AuditHub helps users manage [projects](/saas/guide/concepts/projects). Each project definition contains the metadata that AuditHub requires to facilitate usage of its security tools. 
