...
This sub-section delves even further into the technical details surrounding LTL. If you'd like to skip it, feel free to move onto the [next section](by_example/aggregate_properties.md), where we discuss how to express aggregate properties over sequences of blockchain states within [V] specs.
