...
## Pure and View Function Fuzzing

By default, OrCa does not fuzz pure and view functions because those functions do not affect the contract state. Toggling this setting will enable OrCa to fuzz these functions.
